...
Installation succeeds only after the Azure test passes and finishes with **INSTALLATION COMPLETE**. Existing healthy Core/model data and staff credentials are reused on reinstall.
